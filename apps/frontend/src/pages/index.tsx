...
export const Index = () => {
  return (
    <div className="flex min-h-dvh w-full flex-col">
      <div className="mx-auto flex max-w-screen-md grow flex-col items-center gap-20 bg-white pt-20">
...
const FEATURES = [
  {
    icon: Notification,
    title: 'Notification',
    description: 'Get daily shadow work prompts via email.',
  },
  {
    icon: DownloadSimple,
  ...
  },
  {
    ...
    description: 'Your data is encrypted and secure. We do not share your data with third parties.',
  },
  {
    icon: Lightning,
    title: 'Track Progress',
    description: 'Stay motivated by tracking your progress.',
  },
];
